<a {{ $attributes->merge([
    ...
    'target' => '_blank', 
    'href' => $link->socialNetwork->prefix_link.$link->plain_value['value_any'],
    ...
    <div class="social-name" style="color: {{ $link->plain_value['text_color'] }}">{{ $link->socialNetwork->name }}</div>
